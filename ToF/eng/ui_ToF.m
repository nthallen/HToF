...
f = ne_dialg(f, 'add', 1, 0, 'pToFhcd', 'Cal Dil' );
f = ne_dialg(f, 'add', 1, 0, 'pToFhcal2flow', 'Cal 2 Flow' );
f = ne_dialg(f, 'add', 1, 0, 'pToFhzf', 'Zero Flow 2' );
...
f = ne_dialg(f, 'add', 0, 1, 'gToFz', 'Zaber' );
f = ne_dialg(f, 'add', 1, 0, 'pToFzv', 'Volts' );
f = ne_dialg(f, 'add', 1, 0, 'pToFzp', 'Pos' );
f = ne_dialg(f, 'add', 1, 0, 'pToFzs', 'Stale' );
f = ne_dialg(f, 'newcol');
f = ne_dialg(f, 'add', 0, 1, 'gToFtt', 'Twis Torr' );
f = ne_dialg(f, 'add', 1, 0, 'pToFtti', 'I' );
f = ne_dialg(f, 'add', 1, 0, 'pToFttt', 'T' );
f = ne_dialg(f, 'add', 1, 0, 'pToFtt_v', 'V' );
f = ne_dialg(f, 'add', 1, 0, 'pToFttw', 'W' );
f = ne_dialg(f, 'add', 1, 0, 'pToFtts', 'Speed' );
f = ne_dialg(f, 'add', 1, 0, 'pToFttstatus', 'Status' );
f = ne_dialg(f, 'add', 1, 0, 'pToFtta', 'Aflags' );
f = ne_dialg(f, 'add', 1, 0, 'pToFttb', 'Bflags' );
f = ne_dialg(f, 'add', 1, 0, 'pToFttc', 'Cflags' );
f = ne_dialg(f, 'add', 1, 0, 'pToFttstale', 'Stale' );
f = ne_dialg(f, 'add', 0, 1, 'gToFtte', 'TT Errors' );
f = ne_dialg(f, 'add', 1, 0, 'pToFttetta', 'TTA' );
f = ne_dialg(f, 'add', 1, 0, 'pToFttettb', 'TTB' );
f = ne_dialg(f, 'add', 1, 0, 'pToFttettc', 'TTC' );
